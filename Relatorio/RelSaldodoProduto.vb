...
Public Class RelSaldodoProduto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ESTOQUE.RelSaldodoProduto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRelSaldodoProduto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RelSaldodoProduto = New RelSaldodoProduto()
        rpt.Site = Me.Site
        Return rpt
    End Function

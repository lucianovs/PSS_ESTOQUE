...
Public Class frmTipoDeProdutos
    '?? Alterar para a Entidade Principal ??
    Dim dt As DataTable = New DataTable("ES001")
    ...
    Private Sub TratarObjetos()
        ...
        If i > -1 And Not bIncluir Then
            txtCodigo.Text = dt.Rows(i).Item("ES001_TIPPRO")
            txtDescricao.Text = dt.Rows(i).Item("ES001_DESTIP")
            If dt.Rows(i).Item("ES001_SITCAD") = "A" Then
    ...
    Private Sub btnGravar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGravar.Click
        ...
        If ConectarBanco() Then
            ...
            If Validardados(cMensagem) Then
                If bIncluir Then
                    nProxCod_Registro = ProxCodChave("EES001", "ES001_TIPPRO")
                    cSql = "INSERT INTO EES001 (ES001_TIPPRO, ES001_DESTIP, ES001_SITCAD)"
                ...
                ElseIf bAlterar Then
                    ...
                    cSql = "UPDATE EES001 set ES001_DESTIP='" & Trim(txtDescricao.Text) & _
                            "', ES001_SITCAD ='" & statusativoinativo & _
                            "' where ES001_TIPPRO = " & txtCodigo.Text
    ...
    Private Sub Excluir_Registro()
        ...
        If MsgBox("Deseja excluir este registro?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "cadastro de Usuarios") = MsgBoxResult.Yes Then
            ...
            cSql = "DELETE FROM EES001 where ES001_TIPPRO = " & txtCodigo.Text
            cmd = New OleDbCommand(cSql, g_ConnectBanco)
    ...
    Private Sub frmTipoDeProdutos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Me.Tag = 4 Then
            cQuery = "SELECT * FROM EES001"
        Else
            cQuery = "SELECT * FROM EES001 where ES001_TIPPRO = " & g_Param(1)
        End If
        ...
        If g_Param(1) <> "INSERT" Then
            ...
            For i_point = 0 To dt.Rows.Count() - 1
                If dt.Rows(i_point).Item("ES001_TIPPRO").ToString = g_Param(1) Then
                    Exit For
                End If
            Next
            i = i_point

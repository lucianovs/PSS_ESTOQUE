...
Public Class frmTipoDeMovimentos
    '?? Alterar para a Entidade Principal ??
    Dim dt As DataTable = New DataTable("EES006")
    ...
    Private Sub TratarObjetos()
        ...
        If i > -1 And Not bIncluir Then
            txtCodigo.Text = dt.Rows(i).Item("ES006_TIPMOV")
            txtDescricao.Text = dt.Rows(i).Item("ES006_DESTIP")
            If dt.Rows(i).Item("ES006_SITCAD") = "A" Then
    ...
    Private Sub btnGravar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGravar.Click
        ...
        If ConectarBanco() Then
            ...
            If Validardados(cMensagem) Then
                If bIncluir Then
                    nProxCod_Registro = ProxCodChave("EES006", "ES006_TIPMOV")
                    cSql = "INSERT INTO EES006 (ES006_TIPMOV, ES006_DESTIP, ES006_SITCAD)"
                    ...
                    cSql += " values (" & nProxCod_Registro.ToString & ",'" & txtDescricao.Text & "', '" & statusativoinativo & "')"
                ...
                ElseIf bAlterar Then
                    ...
                    cSql = "UPDATE EES006 set ES006_DESTIP='" & Trim(txtDescricao.Text) & _
                            "', ES006_SITCAD ='" & statusativoinativo & _
                            "' where ES006_TIPMOV = " & txtCodigo.Text
    ...
    Private Sub Excluir_Registro()
        ...
        If MsgBox("Deseja excluir este registro?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "cadastro de Usuarios") = MsgBoxResult.Yes Then
            ...
            cSql = "DELETE FROM EES006 where ES006_TIPMOV = " & txtCodigo.Text
            cmd = New OleDbCommand(cSql, g_ConnectBanco)
    ...
    Private Sub frmTipoDeProdutos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Me.Tag = 4 Then
            cQuery = "SELECT * FROM EES006"
        Else
            cQuery = "SELECT * FROM EES006 where ES006_TIPMOV = " & g_Param(1)
        End If
        ...
        If g_Param(1) <> "INSERT" Then
            ...
            For i_point = 0 To dt.Rows.Count() - 1
                If dt.Rows(i_point).Item("ES006_TIPMOV").ToString = g_Param(1) Then
                    Exit For
                End If
            Next
            i = i_point
